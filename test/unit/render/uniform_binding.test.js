...
const {
    ...
    Uniform3f,
    Uniform4f
} = require('../../../src/render/uniform_binding');
...
test('Uniform1i', (t) => {
    ...
    const context = {
        gl: {
            uniform1i: () => { t.assert.ok(true, 'sets value when unique'); }
        }
    };
...
test('Uniform1f', (t) => {
    ...
    const context = {
        gl: {
            uniform1f: () => { t.assert.ok(true, 'sets value when unique'); }
        }
    };
...
test('Uniform2f', (t) => {
    ...
    const context = {
        gl: {
            uniform2f: () => { t.assert.ok(true, 'sets value when unique'); }
        }
    };
...
test('Uniform3f', (t) => {
    ...
    const context = {
        gl: {
            uniform3f: () => { t.assert.ok(true, 'sets value when unique'); }
        }
    };
...
test('Uniform4f', (t) => {
    ...
    const context = {
        gl: {
            uniform4f: () => { t.assert.ok(true, 'sets value when unique'); }
        }
    };
